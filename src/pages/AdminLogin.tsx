...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-6 md:px-12 py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-2xl border border-white/10 p-10 rounded-[2.5rem] shadow-2xl">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-black text-white mb-2 tracking-tight">{t("admin.login.title")}</h1>
            <p className="text-slate-400 font-medium">{t("admin.login.subtitle")}</p>
          </div>
